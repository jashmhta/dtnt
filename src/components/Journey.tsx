...
const steps = [
  {
    ...
    copy: "Flights, hotels, visas, transfers, itineraries — handled seamlessly",
    img: IMG.journey1,
    side: "right" as const,
  },
  {
    ...
    copy: "Real people, always reachable",
    img: IMG.journey2,
    side: "left" as const,
  },
  {
    n: "3",
    title: "Live Monitoring & Updates",
    copy: "Our team is available around the clock",
    img: IMG.journey3,
    side: "right" as const,
  },
  {
    n: "4",
    title: "Problem Resolution On-the-Go",
